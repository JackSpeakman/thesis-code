...
function [dxPI] = modelPI2(t,xPI,r,Fin,K,para)
% ----- INPUTS --------
...
N_key = [17,7];            % Key trays
T_key = xPI(N_key+44);      % Temperature onkey trays

% Column
N = 21;                 % Trays including reboiler
Nf = 14;                % Feed tray (+ reboiler)
...
%% Run open-loop plant
dxPI(3:69) = modelODE2(t,xPI(3:69),u,Fin,para);
